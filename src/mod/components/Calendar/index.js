      ...
      >
        {showMonthArrow ? (
          <button
            type="button"
            className={
              classnames(styles.nextPrevButton, styles.prevButton) +
              " prevMonth hiddenCalendar"
            }
        ...
        {showMonthArrow ? (
          <button
            type="button"
            className={
              classnames(styles.nextPrevButton, styles.nextButton) +
              " nextMonth hiddenCalendar"
            }
            onClick={() => changeShownDate(+1, "monthOffset")}
        ...
        {ranges.map((range, i) => {
          ...
          return (
            ...
            >
              <DateInput
                className={
                  classnames(styles.dateDisplayItem, {
